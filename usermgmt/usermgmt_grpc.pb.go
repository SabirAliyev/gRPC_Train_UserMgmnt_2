...
type UserManagementClient interface {
	...
	// We add new method with empty message GetUsersParams in input.
	// The reason of using an empty message is because in initial implementaton of this method we simply want to return a list of all users
	// But in future iterations we may want to pass parameters to GetUsers() service method. For instance we may want to pass a regular
	// expression that returns all of subset of users? that match the pattern of the regular expression. So to keep the API backwards
	// compatible we`re going to pass an empty message as the input.
